...
namespace iSpeed
{
    public partial class Form1 : Form
    {
        ...
        public void creat_list_view()
        {
            listView1.Items.Add("format");
            listView1.Items.Add("entfernung");
            listView1.Items.Add("Gewicht");
            listView1.Items.Add("Porto");
        ...
        private void btn_Portorechnen_Click(object sender, EventArgs e)
        {
            if(cbox_Sendungsart.Text != null)
            {
                ...
                listView1.Items.Add(porto.ToString());
        ...
        private void lbl_kg_Click(object sender, EventArgs e)
        {
